...
- 初始化 4 个可替换图片资产位、6 类服务和 4 类客户方案。
...
- **网站图片资产**：替换首页、产品开发、质量检查和物流场景图；保留资产位代码即可自动更新引用页面。
...
模块内 4 张初始业务图片由 OpenAI 图像生成工具为 LightLink 原创建，不包含 JingSourcing 商标、客户照片、案例素材或原站图片。Font Awesome 图标由 Odoo 前端资产提供，后台通过图标名称维护。
